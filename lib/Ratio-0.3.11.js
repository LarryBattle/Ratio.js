...
var Ratio = (function () {
    ...
    */
    ...
    Ratio.reduce = function (obj, obj2) {
        ...
        bottom = top || !obj.denominator ? obj.denominator : 1,
    ...
    Ratio.prototype = {
        ...
        */
        ...
        deepEquals : function (obj) {
            return (obj instanceof Ratio) && (this.numerator === obj.numerator) &&
                (this.denominator === obj.denominator) && (this.divSign === obj.divSign) && 
