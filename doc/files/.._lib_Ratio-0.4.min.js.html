...
<head>
    <meta charset="utf-8">
    <title>..\lib\Ratio-0.4.min.js</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: ..\lib\Ratio-0.4.min.js</h1>
